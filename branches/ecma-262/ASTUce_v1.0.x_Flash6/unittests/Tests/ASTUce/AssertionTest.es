...
/* Constructor: AssertionTest
   ...
   (code)
    ...
    if( this.getError() != null )
        {
        if( this.getError() instanceof buRRRn.ASTUce.AssertionFailedError )
            {
            this.setError( null );
...
Tests.ASTUce.AssertionTest.prototype.testFail = function()
    ...
    */
    ...
    if( this.__e != null )
        {
        if( this.__e instanceof buRRRn.ASTUce.AssertionFailedError )
            {
            this.__e = null;
            return;
            }
...
Tests.ASTUce.AssertionTest.prototype.testAssertNullNotEqualsString = function()
    ...
    if( this.__e != null )
        {
        if( this.__e instanceof buRRRn.ASTUce.ComparisonFailure )
            {
            this.__e = null;
            return;
            }
