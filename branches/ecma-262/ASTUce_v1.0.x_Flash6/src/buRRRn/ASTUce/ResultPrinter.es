...
/* Method: print
*/
buRRRn.ASTUce.ResultPrinter.prototype.print = function( /*TestResult*/ result, /*Number_Date*/ runTime )
    {
...
*/
/*!## TODO: refactor using runTime.valueOf() */
buRRRn.ASTUce.ResultPrinter.prototype.elapsedTimeAsString = function( /*Number_date*/ runTime )
    {
    var dat, ms, s, m, h;
    /*!## TODO: use valueOf
    */
    if( GetTypeOf( runTime ) == "number" ) //core2
        {
        dat = new Date( runTime );
        }
    else if( GetTypeOf( runTime ) == "date" ) //core2
        {
        dat = runTime;
        }
