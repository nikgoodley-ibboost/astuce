/* build info:
   core2 : ECMAScript core objects 2nd gig v1.0.1 for Browsers JavaScript
   Mon Jan 09 2006 13:35:27 GMT+0100
*/
/*
...
_global.$GLOBAL_RESERVED = [ "document", "window", "navigator", "location" ];
_introspectGlobal = function()
{
for( var o in _global )
{
if( (o == "_introspectGlobal") || (o == "$GLOBAL_RESERVED") || (o.toString().charAt(0) == "$") )
{
continue;
}
