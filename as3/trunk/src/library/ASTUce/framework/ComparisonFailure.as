...
package buRRRn.ASTUce.framework
{
    ...
    public class ComparisonFailure extends AssertionFailedError
    {
         ...
         * <p>
         * <b>Note:</b>
         * Ideally we would want to override the message property but that's not possible.
         * </p>
         */
         ...
         * <p><b>Note:</b></p>
         * <p>
         * As toString is declared in the prototype you can not use the override statement the 1st time you declare it, 
         * this because a function declared in a class take priority over a function declared in the prototype.
         * </p>
         * <p>
         * But later if you want to redefine the function in another class inheriting the class where you
         * defined toString you will have to use the statement override.
         * </p>
