...
@project_name@ as an AS3 library is a regression testing framework inspired by the xUnit architecture.
...
@project_name@ as an executable reuse the AS3 library and
...
@project_name@ reuse the edenrr library (http://edenrr.googlecode.com).
